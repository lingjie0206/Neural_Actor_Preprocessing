...
class MV1PMF(MVBase):
    ...
    def vis_smpl(self, vertices, faces, images, nf, sub_vis, use_white=False):
        render_data = {}
        ...
        self.writer.vis_smpl(render_data, nf, images, cameras, use_white=use_white)

    # Lingjie edited
        
    def save_smpl(self, vertices, faces, images, nf, sub_vis):
        self.writer.save_smpl(vertices, faces, nf)
